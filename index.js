...
const UUID = process.env.UUID || '9127e27b-e291-4d88-a897-e5aee3eea145'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'stackhost.vir.kdns.fr';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNDNjYjI4NGVjMDY5NWM1NDc0ZTczMzE4YWNkYzcxYzAiLCJ0IjoiMWQ2NjlkNDUtZTg2ZS00OTQwLWJiOTYtMmY4NDhhYzA0ZDc5IiwicyI6Ik9XWmtZMk5sWVdRdE1EQXdNaTAwWVdGaUxXRTVNakV0TWpReE5tUmlaR00zWW1GaCJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
...
const NAME = process.env.NAME || 'stackhost.org';                        // 节点名称
const CHAT_ID = process.env.CHAT_ID || '8019081926';                  // Telegram chat_id  两个变量不全不推送节点到TG 
const BOT_TOKEN = process.env.BOT_TOKEN || '8657351020:AAGdZ4b6LPvjogB0_s9Xl9vpkrq_tX2hkDY';              // Telegram bot_token 两个变量不全不推送节点到TG 
